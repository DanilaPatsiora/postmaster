    ...
    <div class="main-block">
        ...
        <div class="content">
            ...
            {{ if eq .record.currency "zar" }}
                <p class="text">
                    This is to confirm that you have deposited {{ .record.amount }} ZAR to your JDAX Wallet.
                </p>
                <p class="text">
                    To immediately buy your favoured Cryptocurrency, go <a href="https://stage.jdax.co.za/wallets">here</a>.
                </p>
            {{ else if eq .record.currency "btc" }}
                ...
                <p class="text">
                    ...
                    Address: {{ .record.blockchain_address }}<br>
